    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-indigo-100 to-blue-200 p-4">
            <div className="w-full max-w-md bg-white shadow-xl rounded-2xl p-8 flex flex-col gap-6">
                <h1 className="text-3xl font-extrabold mb-2 text-center text-indigo-700 tracking-tight">HF Choice</h1>
                ...
                <div className="mt-4 text-center">
                    <Link href='/signup'>
                        <span className="text-indigo-600 hover:underline font-medium">Don&apos;t have an account? Sign Up</span>
                    </Link>
                </div>
            </div>
        </div>
